# VENDORED from dynamicslab/hydrogym main branch (hydrogym/core.py, fetched
# 2026-09-14) -- the 1.0.0 solver-agnostic contract (gymnasium-based). Used
# only when the real hydrogym package is not importable in this environment
# (PyPI 0.1.2.1 is the stale 2023 release whose __init__ hard-imports
# firedrake; git main requires python >= 3.10). See core_shim.py.
import abc
