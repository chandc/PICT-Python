...
| T19 | channel Re_τ 395 (MKM 1999 reference, 96×160 × 128 modes, minimal box) | the first LES beyond the validation Re | **prepared** (`run_uchannel25.py --re-tau 395`, `tools/a100/A100_channel_re395.ipynb`); initial field = the 180 DNS field with the mean shifted to MKM's; 2.1–2.8 s/step on the GB10, to be run on the A100 |
