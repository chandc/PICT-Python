// HydroGym medium.geo with the cylinder characteristic length halved (n1 35 -> 70): 220 wall faces,
// wall cell 0.009, 25376 triangles -- the same wall resolution and cell count as the fine butterfly
// (224 faces, 0.012, 27968 quads); wake (n2) and far field (n3) left at the medium values.
n1 = 70;
n2 = 20;
n3 = 1.5;
x_ninf = -5.0;
